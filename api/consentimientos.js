            ...
            if (action === 'saveIndividual') {
                ...
                if (resend) {
                    ...
                    const mailToPaciente = {
                        from: 'Notificación Consentimiento Informado <cinformado@emcotic.com>',
            ...
            if (action === 'savePareja') {
                ...
                if (resend) {
                    ...
                    const correos = [
                        ...
                        { to: 'cinformado@emcotic.com', subject: `Nuevo Consentimiento Pareja: ${dataToSave.paciente1.nombre} y ${dataToSave.paciente2.nombre}` } 
                    ];

                    const emailPromises = correos.map(correo => resend.emails.send({
                        from: 'Notificación Consentimiento <cinformado@emcotic.com>',
                        to: correo.to,
